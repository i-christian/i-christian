...
- 🖥️ Proficient in Go, Python, and Rust.
- 🌐 Interested in server-side development, using frameworks like Axum, Django and FastAPI.
- 📚 Currently mastering golang programming.
- 🔍 Exploring new modern web development techniques.
